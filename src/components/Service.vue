<template>
    <section class="w-full px-4 py-20">
        <div class="container mx-auto">
            <div class="flex flex-row items-center text-center justify-center pb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div class="border-2 border-teal-500 flex flex-col p-4 rounded-md bg-[#F5F8FD] box">
                    <div class="py-3">
                        ...
                        <p class="text-gray-500 text-base py-3 leading-relaxed tracking-wide">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Illo quibusdam, molestiae facilis error quaerat repellendus.
                        </p>
                    </div>
                    <div
